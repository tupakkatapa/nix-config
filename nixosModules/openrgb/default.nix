# Based on Misterio77's declarative OpenRGB module
...
let
  ...
  settingsFile = settingsFormat.generate "OpenRGB.json" cfg.settings;
in
{
  ...
  options.services.hardware.openrgb = {
    ...
    settings = lib.mkOption {
      ...
      default = { };
      description = "Declarative OpenRGB JSON configuration (detectors, device settings, etc.)";
    };
    ...
    motherboard = lib.mkOption {
      ...
      description = "CPU family of motherboard. Allows for additional motherboard i2c support.";
    };
