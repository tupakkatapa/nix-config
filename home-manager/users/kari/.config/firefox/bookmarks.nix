{
  ...
  Development = [
    ...
    # Nix
    { name = "Nix Built-in Functions"; url = "https://nixos.org/manual/nix/unstable/language/builtins.html"; }
    { name = "Nix Data Types"; url = "https://nixos.org/manual/nix/unstable/language/types"; }
    { name = "Nix Operators"; url = "https://nixos.org/manual/nix/unstable/language/operators.html"; }
    ...
    { name = "Nix & Nixpkgs Functions"; url = "https://teu5us.github.io/nix-lib.html"; }
    ...
    { name = "SonarCloud"; url = "https://sonarcloud.io/"; }
  ...
  Media = [
    ...
    { name = "YIFY 1"; url = "https://yts.bz/"; }
    { name = "YIFY 2"; url = "https://yts.gg/"; }
    { name = "YIFY 3"; url = "https://yts.lt/"; }
  ...
  Finance = [
    ...
    { name = "Reth CLI"; url = "https://reth.rs/cli/reth/node"; }
    ...
    { name = "Besu CLI"; url = "https://besu.hyperledger.org/public-networks/reference/cli/options"; }
    ...
    { name = "Erigon CLI"; url = "https://github.com/erigontech/erigon#readme"; }
  ...
  Information = [
    ...
    { name = "Ylilauta"; url = "https://ylilauta.org/"; }
    ...
    { name = "Claude Status"; url = "https://status.anthropic.com/"; }
