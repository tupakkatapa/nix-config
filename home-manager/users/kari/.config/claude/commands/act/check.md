...
Fix all errors and warnings. Repeat until clean. **No lint suppressions** — global principle (`~/.claude/CLAUDE.md` Principles); fix root causes.
...
## 3. Final Pre-commit
Repeat §1's detected invocation once more to catch any regression from fixes (skip if §1 was skipped).
